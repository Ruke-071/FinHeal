...
const Header = () => {
  return (
    ...
    <div className="fixed top-0 left-0 w-full flex justify-between items-center p-4 bg-black shadow-md z-50">
      <nav className="container mx-auto px-4 py-0 bg-black flex justify-between items-center">
